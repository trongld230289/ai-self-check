        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fileItems.forEach(item => {
                item.addEventListener('click', function() {
                    ...
                    if (filePath) {
                        // Send message to VS Code to open new diff for this file
                        console.log('🔄 Opening file:', filePath);
                        
                        // For now, just show a notification that file was clicked
                        // In a full implementation, this would send a message to VS Code
                        // to open a new Monaco diff view for the selected file
                        ...
                        const header = document.querySelector('.file-path');
                        if (header) {
                            header.innerHTML = '🔄 Loading ' + filePath + '...';
                        }
                        
                        // Simulate opening new file (in real implementation, 
                        // this would trigger VS Code command to open new diff)
                        setTimeout(() => {
                            alert('File clicked: ' + filePath + '\\n\\nIn a full implementation, this would open a new Monaco diff view for this file.');
                        }, 500);
                    }
                });
            });
